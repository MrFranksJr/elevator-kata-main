...
//        readInput();
    ...
    private String apiMessage() {
        return "Press P to get the current position of the elevator" + System.lineSeparator()
                ...
                + "  4-2 : A call from the fourth floor to go to the second floor" + System.lineSeparator()
                + "The building only has 5 floors, including the basement and ground floors ";
    }
}
